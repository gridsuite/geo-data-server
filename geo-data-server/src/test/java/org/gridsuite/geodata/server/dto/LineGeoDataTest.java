...
public class LineGeoDataTest {
    ...
    @Test
    public void test() {
        LineGeoData lineGeoData = new LineGeoData("l", Country.FR, Country.FR, "sub1", new ArrayList<>());
        ...
        assertEquals("LineGeoData.LineGeoDataBuilder(id=testId, country1=FR, country2=FR, substationStart=sub1, coordinates=[Coordinate(lat=1.0, lon=2.0), Coordinate(lat=3.0, lon=4.0)])",
                lineGeoDataBuilder.toString());
        assertEquals("LineGeoData(id=testId, country1=FR, country2=FR, substationStart=sub1, coordinates=[Coordinate(lat=1.0, lon=2.0), Coordinate(lat=3.0, lon=4.0)])", lineGeoDataBuilder.build().toString());
